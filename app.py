...
# Net migration by year and region (ignoring sex)
...
if page == "EDA":
    ...
    with col1:
        ...
        line_data = net_df[net_df["region"].isin(regions_selected)]
        fig_line = px.line(
            line_data,
            x="year",
            y="net_migration",
    ...
    with col2:
        ...
        st.write("See how economic variables relate to net migration.")
        ...
        fig_corr.update_layout(height=410)
